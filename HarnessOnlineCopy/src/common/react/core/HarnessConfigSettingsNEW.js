const $HarnessConfigSettings = [
    ...
    { "value":"100", "units":"mins", "title":"CshLockout", "description":"Period of time from current time to lock out scheduling new contacts" },
    { "value":"150", "units":"hrs", "title":"TpPeriod", "description":"Amount of time from current time to generate tasks in Pleniter" },
    { "value":"75", "units":"hrs", "title":"VisPeriod", "description":"Amount of time from current time + contact lockout period by which visibilities are retrieved" },
